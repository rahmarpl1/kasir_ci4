...
<div class="wrapper">
  ...
  <li class="nav-item">
    <a class="nav-link" data-widget="fullscreen" href="#" role="button">
      <i class="faa fa-exvand-arrows-alt"></i>
</a>
</li>
<li class="nav-item">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <img src="<?= base_url('AdminLTE') ?>/dist/img/AdminLTELogo.png" alt="AdminLTELogo.png" class="brand-image img-circle elevation-3" style="opacity: .8">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="<?= base_url('AdminLTE') ?>/dist/img/pto.jpg" class="brand-image img-circle elevation-3" style="opacity: .8">
        </div>
        <div class="info">
      <li class="user-menu text-primary"><?=session()->get('nama_user') ?></li>
        </div>
      </div>
      <!-- Sidebar Menu -->
      <nav class="mt-2">
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Shopiya &copy;<a href="https://adminlte.io"></a>.</strong> All rights reserved.
  </footer>
      </div>
<!-- ./wrapper -->
